...
bool CPythonSkill::RegisterSkillDesc(const char* c_szFileName)
{
	...
	for (DWORD i = 0; i < textFileLoader.GetLineCount(); ++i)
	{
		...
		// Type
		{
			...
			// 20220321.Owsap : Skip MOUNT_UPGRADE
...
CPythonSkill::CPythonSkill()
{
	...
	m_PathNameMap.emplace("MOUNT_UPGRADE", "common/mount_upgrade");
}
CPythonSkill::~CPythonSkill()
{
}
...
BOOL CPythonSkill::SSkillData::IsIgnoreBlock()
{
...
PyObject* skillGetSkillPowerByLevel(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", LocaleService_GetSkillPower(iSkillLevel));
}

#if defined(ENABLE_PARTY_PROFICY)
PyObject* skillGetRoleProficiencyLeaderBonusByLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iSkillLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iSkillLevel))
		return Py_BadArgument();
	...
	return Py_BuildValue("i", LocaleService_GetRoleProficiencyLeaderBonus(iSkillLevel));
}
#endif
...
void initskill()
{
...
#if defined(ENABLE_PARTY_PROFICY)
		{ "GetRoleProficiencyLeaderBonusByLevel", skillGetRoleProficiencyLeaderBonusByLevel, METH_VARARGS },
#endif
	...
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_ATTACK", CPythonSkill::SKILL_FLAG_ATTACK);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_USE_MELEE_DAMAGE", CPythonSkill::SKILL_FLAG_USE_MELEE_DAMAGE);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_COMPUTE_ATTGRADE", CPythonSkill::SKILL_FLAG_COMPUTE_ATTGRADE);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_SELFONLY", CPythonSkill::SKILL_FLAG_SELFONLY);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_SELFONLY", CPythonSkill::SKILL_FLAG_SELFONLY);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_USE_MAGIC_DAMAGE", CPythonSkill::SKILL_FLAG_USE_MAGIC_DAMAGE);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_USE_HP_AS_COST", CPythonSkill::SKILL_FLAG_USE_HP_AS_COST);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_COMPUTE_MAGIC_DAMAGE", CPythonSkill::SKILL_FLAG_COMPUTE_MAGIC_DAMAGE);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_SPLASH", CPythonSkill::SKILL_FLAG_SPLASH);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_GIVE_PENALTY", CPythonSkill::SKILL_FLAG_GIVE_PENALTY);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_USE_ARROW_DAMAGE", CPythonSkill::SKILL_FLAG_USE_ARROW_DAMAGE);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_PENETRATE", CPythonSkill::SKILL_FLAG_PENETRATE);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_IGNORE_TARGET_RATING", CPythonSkill::SKILL_FLAG_IGNORE_TARGET_RATING);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_SLOW", CPythonSkill::SKILL_FLAG_SLOW);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_STUN", CPythonSkill::SKILL_FLAG_STUN);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_HP_ABSORB", CPythonSkill::SKILL_FLAG_HP_ABSORB);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_SP_ABSORB", CPythonSkill::SKILL_FLAG_SP_ABSORB);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_FIRE_CONT", CPythonSkill::SKILL_FLAG_FIRE_CONT);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_REMOVE_BAD_AFFECT", CPythonSkill::SKILL_FLAG_REMOVE_BAD_AFFECT);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_REMOVE_GOOD_AFFECT", CPythonSkill::SKILL_FLAG_REMOVE_GOOD_AFFECT);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_CRUSH", CPythonSkill::SKILL_FLAG_CRUSH);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_POISON", CPythonSkill::SKILL_FLAG_POISON);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_TOGGLE", CPythonSkill::SKILL_FLAG_TOGGLE);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_DISABLE_BY_POINT_UP", CPythonSkill::SKILL_FLAG_DISABLE_BY_POINT_UP);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_CRUSH_LONG", CPythonSkill::SKILL_FLAG_CRUSH_LONG);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_CONFUSION", CPythonSkill::SKILL_FLAG_CONFUSION);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_ELEC", CPythonSkill::SKILL_FLAG_ELEC);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_FIRE", CPythonSkill::SKILL_FLAG_FIRE);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_BLEEDING", CPythonSkill::SKILL_FLAG_BLEEDING);
	PyModule_AddIntConstant(poModule, "SKILL_FLAG_PARTY", CPythonSkill::SKILL_FLAG_PARTY);
