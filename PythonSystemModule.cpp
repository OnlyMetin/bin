...
PyObject* systemSetNightModeOption(PyObject* poSelf, PyObject* poArgs)
{
	...
	CPythonSystem::Instance().SetNightModeOption(bEnable);
	return Py_BuildNone();
}
...
PyObject* systemSetSnowModeOption(PyObject* poSelf, PyObject* poArgs)
{
	...
	CPythonSystem::Instance().SetSnowModeOption(bEnable);
	return Py_BuildNone();
}
...
PyObject* systemSetSnowTextureModeOption(PyObject* poSelf, PyObject* poArgs)
{
	...
	CPythonSystem::Instance().SetSnowTextureModeOption(bEnable);
	return Py_BuildNone();
}
...
PyObject* systemSetAlwaysShowCountryFlag(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetAlwaysShowCountryFlag(iFlag);
	return Py_BuildNone();
}

PyObject* systemIsAlwaysShowCountry(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsAlwaysShowCountry());
}
#endif
...
#if defined(ENABLE_MULTI_LANGUAGE_SYSTEM)
		{ "SetAlwaysShowCountryFlag", systemSetAlwaysShowCountryFlag, METH_VARARGS },
		{ "IsAlwaysShowCountry", systemIsAlwaysShowCountry, METH_VARARGS },
#endif
