...
public:
	...
	enum ESkillFlag
	{
		...
		SKILL_FLAG_COMPUTE_ATTGRADE,
		SKILL_FLAG_SELFONLY,
		SKILL_FLAG_USE_MAGIC_DAMAGE,
		SKILL_FLAG_USE_HP_AS_COST,
		SKILL_FLAG_COMPUTE_MAGIC_DAMAGE,
		SKILL_FLAG_SPLASH,
		SKILL_FLAG_GIVE_PENALTY,
		SKILL_FLAG_USE_ARROW_DAMAGE,
		SKILL_FLAG_PENETRATE,
		SKILL_FLAG_IGNORE_TARGET_RATING,
		SKILL_FLAG_SLOW,
		SKILL_FLAG_STUN,
		SKILL_FLAG_HP_ABSORB,
		SKILL_FLAG_SP_ABSORB,
		SKILL_FLAG_FIRE_CONT,
		SKILL_FLAG_REMOVE_BAD_AFFECT,
		SKILL_FLAG_REMOVE_GOOD_AFFECT,
		SKILL_FLAG_CRUSH,
		SKILL_FLAG_POISON,
		SKILL_FLAG_TOGGLE,
		SKILL_FLAG_DISABLE_BY_POINT_UP,
		SKILL_FLAG_CRUSH_LONG,
		SKILL_FLAG_CONFUSION,
		SKILL_FLAG_ELEC,
		SKILL_FLAG_FIRE,
		SKILL_FLAG_BLEEDING,
		SKILL_FLAG_PARTY,
	...
	enum EHitSkillGrade
	{
		SKILL_HIT_GRADE_MASTER = 19,
		SKILL_HIT_GRADE_GRAND_MASTER = 29,
		SKILL_HIT_GRADE_PERFECT_MASTER = 40,
	};
