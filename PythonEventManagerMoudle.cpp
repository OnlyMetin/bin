...
PyObject* eventGetVisibleLineCount(PyObject* poSelf, PyObject* poArgs)
{
	int iIndex;
	if (!PyTuple_GetInteger(poArgs, 0, &iIndex))
		return Py_BuildException();

	return Py_BuildValue("i", CPythonEventManager::Instance().GetVisibleLineCount(iIndex));
}
...
void initEvent()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetVisibleLineCount", eventGetVisibleLineCount, METH_VARARGS },
