...
bool CAccountConnector::__AuthState_RecvPhase()
{
	...
	else if (kPacketPhase.phase == PHASE_AUTH)
	{
		...
		strncpy(LoginPacket.country, LocaleService_GetLocaleName(), COUNTRY_NAME_MAX_LEN);
		LoginPacket.country[COUNTRY_NAME_MAX_LEN] = '\0';
#endif
...
void CAccountConnector::__BuildClientKey()
{
	...
	old_tea_encrypt((DWORD*)g_adwDecryptKey, (const DWORD*)g_adwEncryptKey, (const DWORD*)c_pszKey, 16);
}
#endif
