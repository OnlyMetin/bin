...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "INSTANCE_TYPE_PET", CActorInstance::TYPE_PET);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_FLOWER_EVENT", CInstanceBase::NEW_AFFECT_FLOWER_EVENT);
#endif
#if defined(ENABLE_DS_SET)
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_DS_SET", CInstanceBase::NEW_AFFECT_DS_SET);
#endif
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_RESEARCHER_ELIXIR", CInstanceBase::NEW_AFFECT_RESEARCHER_ELIXIR);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_HALLOWEEN_EVENT", CInstanceBase::NEW_AFFECT_HALLOWEEN_EVENT);
#endif
#if defined(ENABLE_FISHING_GAME)
	PyModule_AddIntConstant(poModule, "AFFECT_FISHING_GOLD_TUNA", CInstanceBase::AFFECT_FISHING_GOLD_TUNA);
	PyModule_AddIntConstant(poModule, "AFFECT_FISHING_MOVE_SPEED_DOWN", CInstanceBase::AFFECT_FISHING_MOVE_SPEED_DOWN);
#endif
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SAFE_BOX_BUFF", CInstanceBase::NEW_AFFECT_SAFE_BOX_BUFF);
#if defined(ENABLE_SUMMER_EVENT_ROULETTE)
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_LATE_SUMMER_EVENT_BUFF", CInstanceBase::NEW_AFFECT_LATE_SUMMER_EVENT_BUFF);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_LATE_SUMMER_EVENT_PRIMIUM_BUFF", CInstanceBase::NEW_AFFECT_LATE_SUMMER_EVENT_PRIMIUM_BUFF);
#endif
#if defined(ENABLE_GUILD_DRAGONLAIR_SYSTEM)
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_RED_DRAGONLAIR_BUFF", CInstanceBase::NEW_AFFECT_RED_DRAGONLAIR_BUFF);
#endif

#if defined(ENABLE_ELEMENTAL_DUNGEON) 
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_CURSE_OF_ELEMENTAL", CInstanceBase::NEW_AFFECT_CURSE_OF_ELEMENTAL);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_PROTECTION_OF_ELEMENTAL", CInstanceBase::NEW_AFFECT_PROTECTION_OF_ELEMENTAL);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_OF_ELEMENTAL", CInstanceBase::NEW_AFFECT_POTION_OF_ELEMENTAL);
#endif

#if defined(ENABLE_SET_ITEM)
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SET_ITEM", CInstanceBase::NEW_AFFECT_SET_ITEM);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SET_ITEM_SET_VALUE_1", CInstanceBase::NEW_AFFECT_SET_ITEM_SET_VALUE_1);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SET_ITEM_SET_VALUE_2", CInstanceBase::NEW_AFFECT_SET_ITEM_SET_VALUE_2);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SET_ITEM_SET_VALUE_3", CInstanceBase::NEW_AFFECT_SET_ITEM_SET_VALUE_3);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SET_ITEM_SET_VALUE_4", CInstanceBase::NEW_AFFECT_SET_ITEM_SET_VALUE_4);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SET_ITEM_SET_VALUE_5", CInstanceBase::NEW_AFFECT_SET_ITEM_SET_VALUE_5);
#endif

#if defined(ENABLE_CONQUEROR_LEVEL)
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SKILL_9_CHEONUN", CInstanceBase::NEW_AFFECT_SKILL_9_CHEONUN);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SUNGMA_BONUS", CInstanceBase::NEW_AFFECT_SUNGMA_BONUS);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SUNGMA_STR", CInstanceBase::NEW_AFFECT_SUNGMA_STR);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SUNGMA_HP", CInstanceBase::NEW_AFFECT_SUNGMA_HP);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SUNGMA_MOVE", CInstanceBase::NEW_AFFECT_SUNGMA_MOVE);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SUNGMA_IMMUNE", CInstanceBase::NEW_AFFECT_SUNGMA_IMMUNE);
#endif

#if defined(ENABLE_SNOWFLAKE_STICK_EVENT)
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SNOWFLAKE_STICK_EVENT_RANK_BUFF", CInstanceBase::NEW_AFFECT_SNOWFLAKE_STICK_EVENT_RANK_BUFF);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SNOWFLAKE_STICK_EVENT_SNOWFLAKE_BUFF", CInstanceBase::NEW_AFFECT_SNOWFLAKE_STICK_EVENT_SNOWFLAKE_BUFF);
#endif
